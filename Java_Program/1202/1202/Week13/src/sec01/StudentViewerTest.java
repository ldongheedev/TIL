...
class StudentViewer extends JFrame {
    ...
    JButton btnFirst, btnPrev, btnNext, btnLast, btnTotal, btnAvg; // 이동 버튼
    ...
    StudentViewer() {
        ...
        btnTotal.addActionListener(e -> {
            ...
            message("합계: " + s.getTotal());
        });
        
        btnAvg.addActionListener(e -> {
            Student s = list.get(index);
            message(String.format("평균: %.2f", s.getAvg()));
        });
    ...
    //============== 2. 파일 읽기 =============== : 파일내용을 읽어 ArrayList에 저장하기
